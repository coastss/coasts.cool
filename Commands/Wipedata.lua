...
local UserToWipeData = Utilities.ParseDiscordMention(Arguments[1])

pcall(function()
    Database.WipeUserData(UserToWipeData)
end)

return Message:reply(Utilities.CreateEmbed("Coasting", {
    "Wiped data for:",
    Utilities.Constants.MentionUser:format(UserToWipeData)
